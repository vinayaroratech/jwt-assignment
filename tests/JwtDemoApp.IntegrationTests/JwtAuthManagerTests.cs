...
namespace JwtDemoApp.IntegrationTests
{
    ...
    public class JwtAuthManagerTests
    {
        ...
        public void ShouldLoadCorrectJwtConfig()
        {
            ...
            Assert.AreEqual("ASDFGHJKL1234567POIUYTREWQ890MNBZXCV", jwtConfig.Secret);
            Assert.AreEqual(480, jwtConfig.AccessTokenExpiration);
            Assert.AreEqual(600, jwtConfig.RefreshTokenExpiration);
        }
